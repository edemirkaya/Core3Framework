...
namespace CommonCore.Extentions
{
    public static class EnumExtentions
    {
        ...
        public static Object ToDbValue(this Enum instance)
        {
            ...
            Int32 intValue = Convert.ToInt32(instance);
        ...
        {
            Char result = Convert.ToChar(Convert.ToInt32(instance));
            return result;
        }
        ...
        public static Nullable<TEnum> ParseNullable<TEnum>(Object value) where TEnum : struct
        {
            ...
            if (value == null || value == DBNull.Value)
                ...
                result = EnumExtentions.Parse<TEnum>((String)value);

            else if (value is Char)
                result = EnumExtentions.Parse<TEnum>((Char)value);

            else if (value is Int32)
                result = EnumExtentions.Parse<TEnum>((Int32)value);
        ...
        {
            return EnumExtentions.ParseNullable<TEnum>(value).Value;
        }
        ...
        public static List<String> GetDescriptions(Type enumType)
        {
            ...
            List<Enum> values = EnumExtentions.ToEnumList(enumType);
